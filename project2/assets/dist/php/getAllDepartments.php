<?php
	...
	$query1= 'SELECT d.id as id, d.name as Department, l.name as Location, l.id as lID FROM department d LEFT JOIN location l ON (l.id = d.locationID) ORDER BY d.name, d.id, l.name';
